...
const LaptopCode = LucideIcons.LaptopCode || LucideIcons.Laptop || LucideIcons.Monitor;
const FlaskConical = LucideIcons.FlaskConical || LucideIcons.FlaskRound || LucideIcons.Beaker;
const Bot = LucideIcons.Bot || LucideIcons.Cpu;
const Code2 = LucideIcons.Code2 || LucideIcons.Code || LucideIcons.Terminal;
const Users = LucideIcons.Users || LucideIcons.User;

const ICON_MAP = {
  LaptopCode: <LaptopCode className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />,
  FlaskConical: <FlaskConical className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />,
  Bot: <Bot className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />,
  Code2: <Code2 className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />,
  Users2: <Users className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />,
  Users: <Users className="w-[1.8rem] h-[1.8rem] text-[#f1bd0e]" />
};
