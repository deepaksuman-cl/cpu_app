...
═══════════════════════════════════════════════════════════════ */
const galleryData = [
  { id: 1,  title: "Mountain Sunrise",   category: "Nature",    src: "https://picsum.photos/seed/mtns1/900/650",   thumb: "https://picsum.photos/seed/mtns1/400/300"   },
  { id: 2,  title: "Ocean Waves",        category: "Nature",    src: "https://picsum.photos/seed/ocean22/900/650", thumb: "https://picsum.photos/seed/ocean22/400/300" },
  { id: 3,  title: "City Lights",        category: "Urban",     src: "https://picsum.photos/seed/cityx3/900/650",  thumb: "https://picsum.photos/seed/cityx3/400/300"  },
  { id: 4,  title: "Forest Trail",       category: "Nature",    src: "https://picsum.photos/seed/frstx4/900/650",  thumb: "https://picsum.photos/seed/frstx4/400/300"  },
  { id: 5,  title: "Desert Dunes",       category: "Landscape", src: "https://picsum.photos/seed/dsrtx5/900/650",  thumb: "https://picsum.photos/seed/dsrtx5/400/300"  },
  { id: 6,  title: "Snowy Peaks",        category: "Nature",    src: "https://picsum.photos/seed/snwx6/900/650",   thumb: "https://picsum.photos/seed/snwx6/400/300"   },
  { id: 7,  title: "Tropical Beach",     category: "Travel",    src: "https://picsum.photos/seed/bchx7/900/650",   thumb: "https://picsum.photos/seed/bchx7/400/300"   },
  { id: 8,  title: "Autumn Foliage",     category: "Nature",    src: "https://picsum.photos/seed/autx8/900/650",   thumb: "https://picsum.photos/seed/autx8/400/300"   },
  { id: 9,  title: "Waterfall",          category: "Nature",    src: "https://picsum.photos/seed/wflx9/900/650",   thumb: "https://picsum.photos/seed/wflx9/400/300"   },
  { id: 10, title: "Urban Architecture", category: "Urban",     src: "https://picsum.photos/seed/archx10/900/650", thumb: "https://picsum.photos/seed/archx10/400/300" },
  { id: 11, title: "Sunset Harbor",      category: "Travel",    src: "https://picsum.photos/seed/hrbx11/900/650",  thumb: "https://picsum.photos/seed/hrbx11/400/300"  },
  { id: 12, title: "Night Sky",          category: "Landscape", src: "https://picsum.photos/seed/skyx12/900/650",  thumb: "https://picsum.photos/seed/skyx12/400/300"  },
];
...
function Lightbox({ images, startIndex, onClose }) {
  ...
  return (
    <div
      className="gs-lb-backdrop"
      onClick={(e) => e.target === e.currentTarget && onClose()}
    >
      {/* Close */}
      <button
        onClick={onClose}
        className="absolute top-5 right-5 w-10 h-10 rounded-full flex items-center justify-center text-white transition-all duration-200 border border-white border-opacity-20 bg-white bg-opacity-10 hover:bg-red-500 hover:border-red-500"
      >
        <X size={18} />
      </button>
      ...
      <div className="gs-lb-wrap">
        <div className="relative w-full flex items-center justify-center">
          ...
          {/* Prev */}
          <button className="gs-nav prev" onClick={() => go("prev")}>
            <ChevronLeft size={22} />
          </button>
          ...
          {/* Next */}
          <button className="gs-nav next" onClick={() => go("next")}>
        ...
        <div className="flex items-center gap-1.5 mt-4">
          {images.map((_, idx) => (
            <button
              ...
              className={`gs-dot ${idx === current ? "active" : ""}`}
            />
          ))}
        </div>
        ...
        <ThumbStrip
          images={images}
          current={current}
          onSelect={(i) => { setLoaded(false); setCurrent(i); }}
        />
      </div>
    </div>
  );
...
/* ═══════════════════════════════════════════════════════════════
   🃏 IMAGE CARD
═══════════════════════════════════════════════════════════════ */
function ImageCard({ image, colCount, onOpen }) {
  const heights = {
    2: "h-64 sm:h-80",
    3: "h-52 sm:h-64",
    4: "h-44 sm:h-52",
  ...
  return (
    <div className="gs-card">
      ...
      {/* Hover overlay — only zoom icon */}
      <div className="gs-overlay">
        <Link
          href={`/gallery/${image.id}`}
          onClick={(e) => { e.preventDefault(); onOpen(image.id); }}
          className="gs-zoom"
...
/* ═══════════════════════════════════════════════════════════════
   🏠 MAIN GALLERY SECTION  (default export)
═══════════════════════════════════════════════════════════════ */
export default function GallerySection() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-500 max-w-lg mx-auto text-sm sm:text-base leading-relaxed">
            Stunning photographs from around the globe — hover over any image and click the zoom icon to explore.
          </p>
        </div>
