...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Delete existing records to avoid unique constraint violations on re-seeding
    await queryInterface.bulkDelete('aboutpagecontents', null, {});

    await queryInterface.bulkInsert('aboutpagecontents', [
      {
        section_key: 'main_about',
        content: JSON.stringify(mainAboutData),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        section_key: 'our_roots',
        content: JSON.stringify(ourRootsData),
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        section_key: 'vision_mission',
        content: JSON.stringify(visionMissionData),
        createdAt: new Date(),
        updatedAt: new Date()
      }
    ], {});
